  ...
  return(
    <div className="flex justify-between w-full">
      <div className='flex flex-col items-center'>
        ...
        border-2 ${currentStep === 1 ? 'border-[var(--brand-dark)]':'border-[var(--brand-gray-light)]' } rounded-full`}>
      ...
      <div className='flex flex-col items-center'>
        <div className={`p-5 h-10 w-10 flex justify-center items-center 
        border-2 ${currentStep === 2 ? 'border-[var(--brand-dark)]':'border-[var(--brand-gray-light)]' } rounded-full`}>
      ...
      <div className='flex flex-col items-center'>
        <div className={`p-5 h-10 w-10 flex justify-center items-center 
        border-2 ${currentStep === 3 ? 'border-[var(--brand-dark)]':'border-[var(--brand-gray-light)]' } rounded-full`}>
