    ...
    <div className="flex justify-between w-full">
      <div className='flex flex-col items-center'>
        ...
        border-2 border-[var(--brand-dark)] rounded-full">
          <span className="text-lg text-[var(--brand-dark)]">1</span>
        </div>
      ...
      <div className='flex flex-col items-center'>
        ...
        border-2 border-[var(--brand-gray-light)] rounded-full">
          <span className="text-lg text-[var(--brand-gray-light)]">2</span>
        </div>
      ...
      <div className='flex flex-col items-center'>
        <div className="p-5 h-10 w-10 flex justify-center items-center 
        border-2 border-[var(--brand-gray-light)] rounded-full">
          <span className="text-lg text-[var(--brand-gray-light)]">3</span>
        </div>
